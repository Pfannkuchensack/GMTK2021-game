    ...
    data: () => {
        return {
            ...
            itemstypes: [
                ...
                { type: 11, name: "Schwert Schaft", ticks: -1, icon: "/images/items/broad-dagger-hilt.png" },
                { type: 12, name: "Axt Schaft", ticks: -1 },
                { type: 13, name: "Harke Schaft", ticks: -1 },
                { type: 14, name: "Werkzeug Schaft", ticks: -1 },
                { type: 20, name: "Schwertklinge", ticks: -1, icon: "/images/items/broad-dagger-blade.png" },
